...
const projectsData = [
  ...
  // 4. Oranyfy - E-commerce Platform

  {
    id: "Oranyfy",
    live: "https://organyfy.com/",
    code: "",
    codePanel: {
      title: "Oranyfy.com — E-commerce Food Platform",
      subtitle: "client project • Online store",
      badge: "MERN • Client",
      lines: [
        <span key="1">
          <span className="text-fuchsia-400">const</span>{" "}
          <span className="text-emerald-300">Oranyfy</span>{" "}
          <span className="text-slate-300">=</span>{" "}
          <span className="text-cyan-300">{"{"}</span>
        </span>,
        <span key="2" className="pl-4">
          <span className="text-slate-400">name</span>
          <span className="text-slate-300">:</span>{" "}
          <span className="text-amber-300">'Oranyfy.com'</span>
          <span className="text-cyan-300">,</span>
        </span>,
        <span key="3" className="pl-4">
          <span className="text-slate-400">domain</span>
          <span className="text-slate-300">:</span>{" "}
          <span className="text-slate-200">"E-commerce • Food"</span>
          <span className="text-cyan-300">,</span>
        </span>,
        <span key="4" className="pl-4">
          <span className="text-slate-400">features</span>
        ...
        <span key="5" className="pl-8">
          <span className="text-slate-200">"Product search & filtering"</span>
          <span className="text-cyan-300">,</span>
        </span>,
        <span key="6" className="pl-8">
          <span className="text-slate-200">"Admin product management"</span>
          <span className="text-cyan-300">,</span>
        </span>,
       
        <span key="7" className="pl-4">
          <span className="text-cyan-300">]</span>
          <span className="text-cyan-300">,</span>
        </span>,
        <span key="8" className="pl-4">
          <span className="text-slate-400">role</span>
          <span className="text-slate-300">:</span>{" "}
          <span className="text-slate-200">
            "Full-stack development & API integration"
    ...
    shotsPanel: {
      shots: [
        { src: "Oranyfy/Login.png", caption: "Login — Admin panel" },
        { src: "Oranyfy/image.png", caption: "Home — food search" },
        {
          src: "Oranyfy/heroimg.png",
          caption: "Products — Featured foods",
        },
        { src: "Oranyfy/addtocart.png", caption: "Cart — Add to cart" },
        { src: "Oranyfy/img.png", caption: "Our Specials Products" },
        {src: "Oranyfy/blog.png", caption: "Blog — News and updates" },
      ],
    },
  },
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        ...
        >
          <a
            href="https://github.com/Ansari1jamal"
            target="_blank"
