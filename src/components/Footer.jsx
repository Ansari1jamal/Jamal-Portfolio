  ...
  const socialLinks = [
    {
      icon: FaGithub,
      label: "GitHub",
      link: "https://github.com/Ansari1jamal",
      color: "hover:bg-gray-700",
    },
    {
      icon: FaLinkedin,
      label: "LinkedIn",
      link: "https://www.linkedin.com/in/ansarijamal/",
...

    {
      icon: HiMail,
      label: "Email",
      link: "mailto:ansari1jamal1@gmail.com",
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-slate-400 text-sm">
            © {currentYear} Jamal Ahmad Ansari. All Rights Reserved.
          </p>
